...
async function getFHEVMRelayerMetadata(rpcUrl: string) {
  ...
  try {
    ...
    throw new Error(
      `The URL ${rpcUrl} is not a FHEVM Hardhat node or is not reachable.`
    );
  } finally {
    rpc.destroy();
  }
...
/**
 * Create FHEVM instance (Mock or Relayer based on network)
 */
export const createFhevmInstance = async (parameters: {
  ...
  if (isMock) {
    console.log(`[FHEVM] Detected Mock mode (chain ${chainId})`);
    ...
    if (fhevmRelayerMetadata) {
      ...
      // 
      //////////////////////////////////////////////////////////////////////////
      console.log("[FHEVM] Loading Mock utils...");
      ...
      console.log("✅ Created FHEVM Mock instance");
      return mockInstance;
    }
  }
  ...
  console.log(`[FHEVM] Using Relayer mode (chain ${chainId})`);
  ...
  console.log("✅ Created FHEVM Relayer instance");
  return instance;
};
